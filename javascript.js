...
modalMessage = document.getElementById('gameWon');
...
function vergleich () {
  if (JSON.stringify(versuch) === JSON.stringify(magicCode)) {
      modalMessage.insertAdjacentHTML = '<div class="alert alert-success" role="alert"><p>This is a success alert—check it out!</p></div>';
  }
